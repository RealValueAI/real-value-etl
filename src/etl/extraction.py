...
class CianExtractor(S3Extractor):
    def __init__(self, config):
        super().__init__(config)
        self.logger = get_logger('cian_extractor_logger')
        self.logger.info("CianExtractor initialized.")
...
class AvitoExtractor(S3Extractor):
    def __init__(self, config):
        super().__init__(config)
        self.logger = get_logger('avito_extractor_logger')
        self.logger.info("AvitoExtractor initialized.")
